...
namespace Abot.Crawler
{
    ...
    public abstract class WebCrawler : IWebCrawler
    {
            ...
            IMemoryManager memoryManager)
        {
            ...
            _scheduler = scheduler ?? new Scheduler(_crawlContext.CrawlConfiguration.IsUriRecrawlingEnabled, null, null, null);
            ...
            _hyperLinkParser = hyperLinkParser ?? new AngleSharpHyperlinkParser(_crawlContext.CrawlConfiguration, null);
        ...
        protected virtual void FirePageCrawlStartingEventAsync(PageToCrawl pageToCrawl)
        {
            ...
            if (threadSafeEvent != null)
            {
                ...
                {
                    Task.Run(() => { del(this, new PageCrawlStartingArgs(_crawlContext, pageToCrawl)); });
                }
            }
        }
        ...
        /* Removed to avoid a long list of dependencies behind System.Configuration
         * 
